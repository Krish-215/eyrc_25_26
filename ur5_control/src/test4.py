...
TOP_REGION_HEIGHT_RATIO = 0.95  # Check top 30% of fruit bbox
TOP_REGION_EXTEND_UP = 0      # Pixels to extend above bbox
MIN_GREEN_PIXELS = 1000          # Minimum green pixels to confirm bad fruit
...
class FruitsTF(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Detection method: Grey body + Green top")
    ...
    def bad_fruit_detection(self, rgb_image):
        ...
        # Green: hue 35-85, reasonable saturation and value
        ...
        for contour in contours_gray:
            ...
            # Define top region: extends slightly above bbox, covers top 30% of height
    ...
    def process_image(self):
        ...
        for fruit in bad_fruits:
            ...
            # Draw visualization (red for bad fruit - matches your reference code)
            ...
            cv2.putText(display_img, f"ID:{fruit_id} D:{depth_m:.2f}m G:{green_pixels}", 
                       (cX - 40, cY - 10),
            ...
            try:
                ...
                self.get_logger().info(
                    f"Published {child_name}: base({p_base[0]:.3f}, {p_base[1]:.3f}, {p_base[2]:.3f}) green_px={green_pixels}"
                )
